...
function mongoConnect() {
    return new Promise((resolve, reject) => {
    var mongoURL = process.env.MONGO_URL || 'mongodb://admin1:RoboShop1@roboshop-dev-docdb.cluster-cxcoggokunq6.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false';
...
// fire it up!
const port = process.env.CATALOGUE_SERVER_PORT || '3000';
app.listen(port, () => {
